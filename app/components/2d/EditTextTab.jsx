...
const EditTextTab = ({ editor, layerManager }) => {
  ...
  const handleFontStyleChange = (styleType) => {
    if (is3D) {
      ...
      if (styleType === "bold") {
        setthreeDTextFontWeight((prev) =>
          prev === "bold" ? "normal" : "bold"
        );
      } else if (styleType === "italic") {
        setthreeDTextFontStyle((prev) =>
            ...
            <div className="kr-edit-text-font-controls kr-reset-margin-padding">
              ...
              >
                ...
                <img
                  ...
                  alt="arrow"
                  className="kr-edit-text-font-arrow"
                />
              </div>
          ...
          {selectedProduct.ProductType === "2d" && (
            <>
              <div className="kr-edit-text-sliders kr-reset-margin">
                <label className="kr-edit-text-slider-label kr-reset-margin-padding">
                  Size
                </label>
                <input
                  type="range"
